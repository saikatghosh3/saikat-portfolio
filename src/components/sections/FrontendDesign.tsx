...
export const FrontendDesign = () => {
  return (
    <section id="frontend-design" className="relative py-16 sm:py-20 overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-48 w-96 h-96 bg-indigo-500/5 rounded-full blur-2xl animate-pulse" />
      <div className="absolute bottom-1/4 -left-48 w-96 h-96 bg-purple-500/5 rounded-full blur-2xl animate-pulse delay-1000" />
