...
export const projects: Project[] = [
  ...
  {
    title: "HealthCare",
    description: "A full-featured Healthcare platform with patient portal and payment integration",
    technologies: ["React", "TypeScript", "Tailwind CSS", "Redux"],
    imageUrl: image5, 
  ...
  },
  {
    ...
    imageUrl: image2,
    liveUrl: "https://business-portfolio-website-responsive.vercel.app/",
    githubUrl: "https://github.com"
  },
  {
    title: "Movie app",
